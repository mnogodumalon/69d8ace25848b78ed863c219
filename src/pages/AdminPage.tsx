...
const KATEGORIEN_FIELDS = [
  ...
  { key: 'farbe', label: 'Farbe', type: 'lookup/select', options: [{ key: 'rot', label: 'Rot' }, { key: 'blau', label: 'Blau' }, { key: 'gruen', label: 'Grün' }, { key: 'gelb', label: 'Gelb' }, { key: 'orange', label: 'Orange' }, { key: 'lila', label: 'Lila' }, { key: 'grau', label: 'Grau' }, { key: 'schwarz', label: 'Schwarz' }, { key: 'weiss', label: 'Weiß' }] },
];
const KONTAKTE_FIELDS = [
  ...
  { key: 'kategorie', label: 'Kategorie', type: 'applookup/select', targetEntity: 'kategorien', targetAppId: 'KATEGORIEN', displayField: 'name' },
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'kontakte' && fieldKey === 'kategorie') {
