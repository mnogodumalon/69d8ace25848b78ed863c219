...
export function KontakteDialog({ open, onClose, onSubmit, defaultValues, kategorienList, enablePhotoScan = true, enablePhotoLocation = true }: KontakteDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'kontakte');
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      setFields(prev => {
        ...
        if (kategorieName) {
          const kategorieMatch = kategorienList.find(r => matchName(kategorieName!, [String(r.fields.name ?? '')]));
